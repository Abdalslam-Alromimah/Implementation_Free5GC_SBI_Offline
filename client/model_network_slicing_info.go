...
type _NetworkSlicingInfo NetworkSlicingInfo
...
func (o *NetworkSlicingInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkSlicingInfo := _NetworkSlicingInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNetworkSlicingInfo)

	if err != nil {
		return err
	}

	*o = NetworkSlicingInfo(varNetworkSlicingInfo)
