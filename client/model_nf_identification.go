...
type _NFIdentification NFIdentification
...
func (o *NFIdentification) UnmarshalJSON(data []byte) (err error) {
	...
	varNFIdentification := _NFIdentification{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNFIdentification)

	if err != nil {
		return err
	}

	*o = NFIdentification(varNFIdentification)
