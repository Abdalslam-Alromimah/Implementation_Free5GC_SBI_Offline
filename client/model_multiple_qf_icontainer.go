...
type _MultipleQFIcontainer MultipleQFIcontainer
...
func (o *MultipleQFIcontainer) UnmarshalJSON(data []byte) (err error) {
	...
	varMultipleQFIcontainer := _MultipleQFIcontainer{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultipleQFIcontainer)

	if err != nil {
		return err
	}

	*o = MultipleQFIcontainer(varMultipleQFIcontainer)
