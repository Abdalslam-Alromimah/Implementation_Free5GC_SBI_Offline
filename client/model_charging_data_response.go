...
type _ChargingDataResponse ChargingDataResponse
...
func (o *ChargingDataResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varChargingDataResponse := _ChargingDataResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChargingDataResponse)

	if err != nil {
		return err
	}

	*o = ChargingDataResponse(varChargingDataResponse)
