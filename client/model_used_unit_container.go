...
type _UsedUnitContainer UsedUnitContainer
...
func (o *UsedUnitContainer) UnmarshalJSON(data []byte) (err error) {
	...
	varUsedUnitContainer := _UsedUnitContainer{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUsedUnitContainer)

	if err != nil {
		return err
	}

	*o = UsedUnitContainer(varUsedUnitContainer)
