...
// SetPduSetQosDl gets a reference to the given PduSetQosParaRm and assigns it to the PduSetQosDl field.
...
// SetPduSetQosUl gets a reference to the given PduSetQosParaRm and assigns it to the PduSetQosUl field.
...
func (o *QosData) UnmarshalJSON(data []byte) (err error) {
