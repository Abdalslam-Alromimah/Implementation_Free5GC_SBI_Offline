...
type _ChargingDataRequest ChargingDataRequest
...
func (o *ChargingDataRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varChargingDataRequest := _ChargingDataRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChargingDataRequest)

	if err != nil {
		return err
	}

	*o = ChargingDataRequest(varChargingDataRequest)
