...
type _ServingNetworkFunctionID ServingNetworkFunctionID
...
func (o *ServingNetworkFunctionID) UnmarshalJSON(data []byte) (err error) {
	...
	varServingNetworkFunctionID := _ServingNetworkFunctionID{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varServingNetworkFunctionID)

	if err != nil {
		return err
	}

	*o = ServingNetworkFunctionID(varServingNetworkFunctionID)
