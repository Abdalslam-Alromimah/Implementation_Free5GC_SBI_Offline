	...
	return []Route{ 
		{
			...
			handleFunctions.DefaultAPI.OfflinechargingdataOfflineChargingDataRefReleasePost,
		},
		{
			...
			handleFunctions.DefaultAPI.OfflinechargingdataOfflineChargingDataRefUpdatePost,
		},
		{
			"OfflinechargingdataPost",
			http.MethodPost,
			"/nchf-offlineonlycharging/v1/offlinechargingdata",
			handleFunctions.DefaultAPI.OfflinechargingdataPost,
		},
	}
}
